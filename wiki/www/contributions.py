...
def get_user_contributions(start, limit):
	contributions = []
	wiki_page_patches = dontmanage.get_list(
		"Wiki Page Patch",
	...
	for wiki_page_patch in wiki_page_patches:
		route = dontmanage.db.get_value("Wiki Page", wiki_page_patch.wiki_page, "route")
		...
		wiki_page_patch.creation = dontmanage.utils.pretty_date(wiki_page_patch.creation)
